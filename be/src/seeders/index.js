...
const aiRecommendationSeeder = require('./aiRecommendationSeeder');
const aiUserPreferencesSeeder = require('./aiUserPreferencesSeeder');
const aiFeedbackSeeder = require('./aiFeedbackSeeder');
...
async function runSeeders() {
  try {
    ...
    // 11. Seed AI User Preferences (depends on Candidates/Users)
    await aiUserPreferencesSeeder();
    console.log('✅ AI User Preferences seeded successfully\n');

    // 12. Seed AI Recommendations (depends on Applications, Candidates, Jobs)
    await aiRecommendationSeeder();
    console.log('✅ AI Recommendations seeded successfully\n');

    // 13. Seed AI Feedback (depends on AI Recommendations)
    await aiFeedbackSeeder();
    console.log('✅ AI Feedback seeded successfully\n');
