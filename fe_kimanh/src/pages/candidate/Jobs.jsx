                ...
                <div className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-y-3 gap-x-6 text-sm text-gray-600 mb-4 mt-3">
                      ...
                      <div className="text-gray-700 mb-4 text-sm leading-relaxed prose prose-sm max-w-none">
