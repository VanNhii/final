              ...
              <div key={application.id} className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center">
                    {application.avatar ? (
                      <img src={getAvatarUrl(application.avatar)} alt={application.candidateName} className="w-full h-full rounded-full object-cover" />
                    ) : (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex space-x-4 text-sm">
                        ...
                        <a href={getCVUrl(application.cvUrl)} target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700 font-medium">
                          Tải CV
                        </a>
