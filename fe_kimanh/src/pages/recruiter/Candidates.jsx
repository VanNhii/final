            ...
            <div className="flex justify-between items-center">
              ...
              {selectedCandidates.length > 0 && (
                <div className="flex space-x-2">
                  <span className="text-sm text-gray-500 italic"> Đã chọn {selectedCandidates.length} ứng viên </span>
                </div>
              )}
            </div>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900">{formatLocation(selectedCandidate.location)}</p>
                    </div>
                    <div>
