...
const RecommendedJobs = () => {
  ...
  const fetchRecommendations = async (showLoader = true, filterOverride = null, force = false) => {
    try {
      if (showLoader) setLoading(true);
      else setRefreshing(true);

      const filtersToUse = filterOverride || filters;
      const response = await aiService.getJobRecommendations({ ...filtersToUse, force });
  ...
  const handleRefresh = () => {
    fetchRecommendations(false, null, true);
  };
      ...
      <div className="mb-6 bg-white p-4 rounded-lg shadow">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="flex items-end gap-2">
            <button
              onClick={() => fetchRecommendations(true, filters, true)}
            ...
            <button
              onClick={() => {
                ...
                fetchRecommendations(true, defaultFilters, true);
              }}
